                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <div class="header-top-right">
                            <ul>
                                <li class="slide-toggle"><a href="#">My Account <i class="fa fa-angle-down"></i></a>
                                    <ul class="show-toggle">
                                        <li><a href="{{route('logout')}}"><i class="fa fa-key"></i> logout</a></li>
                                        <li><a href="#"><i class="fa fa-heart"></i> wishlist</a></li>
                                        <li><a href="#"><i class="fa fa-signal"></i> compare</a></li>
                                        <li><a href="#"><i class="fa fa-shopping-cart"></i> shopping cart</a></li>
                                    </ul>
                                </li>
                            </ul>
                            <ul>
                                <li class="slide-toggle-2"><a href="#"><img src="assets/images/eng/1.webp" alt="" />English <i class="fa fa-angle-down"></i></a>
                                    <ul class="show-toggle-2">
                                        <li><a href="#"><img src="assets/images/eng/2.webp" alt="" />English 2</a></li>
                                        <li><a href="#"><img src="assets/images/eng/3.webp" alt="" /> English 3</a></li>
                                    </ul>
                                </li>
                            </ul>
                            <ul>
                                <li class="slide-toggle-3"><a href="#">USD <i class="fa fa-angle-down"></i></a>
            ...
            <div class="mainmenu">
                <nav>
                    <ul class="menu-list justify-content-center">
                        ...
                        <li><a href="{{route('shop')}}">Xem sách</a></li>
                        <li><a href="#">Thêm <i class="fa fa-angle-down"></i></a>
                            <ul class="submenu">
                                <li><a href="{{route('wishlist')}}">Sản phẩm yêu thích</a></li>
                                <li><a href="{{route('cart')}}">Giỏ hàng</a></li>
                                <li><a href="checkout.html">Sản phẩm đã mua</a></li>
                                <li><a href="account.html">Tài khoản </a></li>
                                <li><a href="{{route('login')}}">Đăng nhập</a></li>
                                <li><a href="{{route('about')}}">Về cửa hàng</a></li>
                                <li><a href="{{route('compare')}}">So sánh mặt hàng</a></li>
                            </ul>
                        </li>
